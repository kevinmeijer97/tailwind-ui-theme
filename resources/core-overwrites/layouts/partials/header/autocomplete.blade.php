@php $inputClasses = 'border !border-tut-border !text-base !min-h-0 outline-none !h-auto rounded !p-4 !bg-white w-full focus:!border-inactive' @endphp
...
>
    <x-rapidez::reactive-base slot-scope="{ results, resultsCount, searchAdditionals, debounce, size, highlight }">
        ...
        >
            ...
            >
                <div v-if="isOpen && (suggestions.length || resultsCount)">
